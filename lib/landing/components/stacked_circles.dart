...
import 'package:AFCSCMS/landing/components/circles.dart';
      ...
      child: new Stack(
        children: <Widget>[
          new Align(
            ...
            child: new Circle(color: Colors.blue, diameter: circleDiameter),
          ),
          new Align(
            alignment: new Alignment(0.5, 0.0),
            child: new Opacity(
              opacity: 0.8,
              child: new Circle(color: Colors.red, diameter: circleDiameter),
            ),
          ),
        ],
      ),
...
class StackedCirclesAnimation extends StatelessWidget {
  ...
  StackedCirclesAnimation({Key key, this.controller})
      : diameter = new Tween<double>(end: 25.0, begin: 30.0).animate(
            new CurvedAnimation(
                parent: controller,
    ...
    return new Stack(
      children: <Widget>[
        new Align(
          ...
          child: new Circle(color: Colors.blue, diameter: diameter.value),
        ),
        new Align(
          alignment: alignment1.value,
          child: new Opacity(
            opacity: 0.8,
            child: new Circle(color: Colors.red, diameter: diameter.value),
          ),
        ),
      ],
    );
